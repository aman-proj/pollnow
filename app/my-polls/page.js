...
import { getMyPolls } from "@/lib/mockData";
    ...
    <div className="max-w-3xl mx-auto px-6 py-12">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-[#6b6b80]">Polls you created with live voting stats</p>
        </div>
        <Link
          href="/create"
      ...
      {polls.length === 0 ? (
        <div className="glass-card rounded-3xl p-12 text-center glow-sm">
          ...
          <p className="text-sm text-[#6b6b80] mb-6">Create your first poll and start collecting votes.</p>
          <Link
            href="/create"
                ...
                >
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-1.5">
                      ...
                      <span className="text-xs text-[#6b6b80]">{poll.options.length} options</span>
      ...
      <Link
        href="/create"
        className="sm:hidden fixed bottom-6 right-6 w-14 h-14 rounded-2xl bg-gradient-to-r from-[#6c5ce7] to-[#5a4bd1] text-white shadow-xl shadow-[#6c5ce7]/30 flex items-center justify-center hover:scale-110 transition-all duration-300"
      >
